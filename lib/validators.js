...
exports.validateOptions = async (options) => {
    ...
    sanitizedOptions.number = exports.positiveIntegerValidator('number', options.number);
    if (sanitizedOptions.number === null) {
        sanitizedOptions.number = constants.DEFAULT_NUMBER;
    }

    sanitizedOptions.evolved = exports.booleanValidator('evolved', options.evolved);
    sanitizedOptions.unique = exports.booleanValidator('unique', options.unique);
    sanitizedOptions.randomType = exports.booleanValidator('randomType', options.randomType);
    sanitizedOptions.type = await exports.typeValidator('type', options.type);
    sanitizedOptions.superEffective = await exports.typeValidator('superEffective', options.superEffective);
